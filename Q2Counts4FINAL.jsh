// creates 4 graphs of delta pT^2 vs. A for 4 equal bins of q2
...
// this next part creates 4 equal statistical bins of q2 (1st bin has the data with the lowest values of q2, 4th bin has the data with the highest values of q2)
...
TCanvas c1 = new TCanvas("q2.3",800,800);

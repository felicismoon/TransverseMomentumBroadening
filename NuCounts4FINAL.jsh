// creates 4 graphs of delta pT^2 vs. A for 4 equal bins of nu
...
// ntuple files to use
String fileName1 = "ntuple_C_NposCOPY.hipo"; // fixed
String fileName2 = "ntuple_Fe_NposCOPY.hipo"; // fixed
...
// this next part creates 4 equal statistical bins of nu (1st bin has the data with the lowest values of nu, 4th bin has the data with the highest values of nu)
...
TCanvas c1 = new TCanvas("nu.3",800,800);

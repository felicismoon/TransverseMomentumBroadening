// this creates graphs of q2 vs. delta pt^2 for the three different elements
...
List vec = tree1.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==0",entries1);
List vec1 = tree1.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==1",entries1);
List vec2 = tree2.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==0",entries2);
List vec3 = tree2.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==1",entries2);
List vec4 = tree3.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==0",entries3);
List vec5 = tree3.getDataVectors("q2","pFidCut==1&&eFidCut==1&&iTgt==1",entries3);
...
// this creates histograms of the q2 data for the 3 elements' heavy and deuterium targets
for (int i = 0; i < 6; i++) {	
	String hname = "hpT2_" + i;
	histyArray[i] = new H1F().create(hname, q2_nBins, (DataVector)vecArray[i].get(0),q2_lower,q2_higher);
	
}

// this next part creates the equal statistical bins of q2 (1st bin hasthe data with the lowest values of q2, 4th bin has the data with the highest values of q2)
...
for (int i = 0; i < 6; i++) {
	treeNumber[i].reset();
	vecArray[4*(i+1)+2] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&q2<"+finalBinNum1Array[i],entriesArray[i]);
	
	treeNumber[i].reset();
	vecArray[4*(i+1)+3] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&q2>"+finalBinNum1Array[i]+"&&q2<"+finalBinNum2Array[i],entriesArray[i]);

	treeNumber[i].reset();
	vecArray[4*(i+1)+4] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&q2>"+finalBinNum2Array[i]+"&&q2<"+finalBinNum3Array[i],entriesArray[i]);

	treeNumber[i].reset();
	vecArray[4*(i+1)+5] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&q2>"+finalBinNum3Array[i],entriesArray[i]);
}
...
// this finds the average value of q2 within each bin to plot against the value of delta pT^2
...
// this part is because there is a different average value for each element bin: the deuterium average and the heavy target average
...
graph.setTitle("#Delta pT^2 vs Q^2 for Carbon");
graph.setTitleY("#Delta pT^2 (GeV^2/c^2)");
graph.setTitleX("Q^2 (GeV^2)");
...
graph1.setTitle("#Delta pT^2 vs Q^2 for Iron");
graph1.setTitleY("#Delta pT^2 (GeV^2/c^2)");
graph1.setTitleX("Q^2 (GeV^2)");
...
graph2.setTitle("#Delta pT^2 vs Q^2 for Lead");
graph2.setTitleY("#Delta pT^2 (GeV^2/c^2)");
graph2.setTitleX("Q^2 (GeV^2)");

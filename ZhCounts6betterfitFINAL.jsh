// creates 6 graphs of pT2 vs. A for 6 equal bins of zh but with ln and power series fits
...
//[c]+([a]*log(x))
// messed with this one

// tried this: [a]*logb(2.718)[B](x)+[c]
// tried this: [a]*logb(2.718)(x)+[c]

// goes with the second graph 
F1D func = new F1D("func","[a]*x^[b]", 0, 210);
DataFitter.fit(func, graph, "Q");
F1D func1 = new F1D("func1","[a]*log(x)+[c]", 1, 210); 
...
F1D func2 = new F1D("func2","[a]*x^[b]", 0, 210);
DataFitter.fit(func2, graph1, "Q");
F1D func3 = new F1D("func3","[a]*log(x)+[c]", 1.5, 210); //1
DataFitter.fit(func3, graph1, "Q");
func2.setLineColor(33);
func2.setLineWidth(3);
func3.setLineColor(24);
func3.setLineWidth(3);

F1D func4 = new F1D("func4","[a]*x^[b]", 0, 210);
DataFitter.fit(func4, graph2, "Q");
F1D func5 = new F1D("func5","[a]*log(x)+[c]", 1.5, 210); //1
DataFitter.fit(func5, graph2, "Q");
func4.setLineColor(33);
func4.setLineWidth(3);
func5.setLineColor(24);
func5.setLineWidth(3);

// this is the first graph
F1D func6 = new F1D("func6","[a]*x^[b]", 0, 210);
DataFitter.fit(func6, graph3, "Q");
F1D func7 = new F1D("func7","[a]*log(x)+[c]", .05, 210);
DataFitter.fit(func7, graph3, "Q");
func6.setLineColor(33);
func6.setLineWidth(3);
func7.setLineColor(24);
func7.setLineWidth(3);


F1D func9 = new F1D("func9","[a]*x^[b]", 0, 210);
DataFitter.fit(func9, graph4, "Q");
F1D func10 = new F1D("func10","[a]*log(x)+[c]", 1.5, 210); //1
DataFitter.fit(func10, graph4, "Q");
func9.setLineColor(33);
func9.setLineWidth(3);
func10.setLineColor(24);
func10.setLineWidth(3);



F1D func11 = new F1D("func11","[a]*x^[b]", 0, 210);
DataFitter.fit(func11, graph5, "Q");
F1D func12 = new F1D("func12","[a]*log(x)+[c]", .01, 210);
DataFitter.fit(func12, graph5, "Q");
func11.setLineColor(33);
func11.setLineWidth(3);
func12.setLineColor(24);
func12.setLineWidth(3);
...
System.out.println("Line of best fit values for a*x^b: a = " + func6.getParameter(0) + " b = " + func6.getParameter(1));
System.out.println("Line of best fit values for a*log(x)+c a = " + func7.getParameter(0) + " c = " + func7.getParameter(1));
...
System.out.println("Line of best fit values for a*x^b: a = " + func2.getParameter(0) + " b = " + func2.getParameter(1));
System.out.println("Line of best fit values for a*log(x)+c a = " + func3.getParameter(0) + " c = " + func3.getParameter(1));



System.out.println("Fourth Interval**************");
System.out.println("Line of best fit values for a*x^b: a = " + func4.getParameter(0) + " b = " + func4.getParameter(1));
System.out.println("Line of best fit values for a*log(x)+c a = " + func5.getParameter(0) + " c = " + func5.getParameter(1));


System.out.println("Fifth Interval**************");
System.out.println("Line of best fit values for a*x^b: a = " + func9.getParameter(0) + " b = " + func9.getParameter(1));
System.out.println("Line of best fit values for a*log(x)+c a = " + func10.getParameter(0) + " c = " + func10.getParameter(1));


System.out.println("Sixth Interval**************");
System.out.println("Line of best fit values for a*x^b: a = " + func11.getParameter(0) + " b = " + func11.getParameter(1));
System.out.println("Line of best fit values for a*log(x)+c a = " + func12.getParameter(0) + " c = " + func12.getParameter(1));

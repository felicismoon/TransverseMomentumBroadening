// creates 6 graphs of delta pT^2 vs. A divided by bins of zh. On each graph is the data further divided into 4 bins of nu

// NOTE: all the variables are called q2 but this really is for the nu data
...
for (int i = 0; i < 6; i++) {
	treeNumber[i].reset();
	pT2vecArray[6*i] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh<"+finalBinNum1Array[i],entriesArray[i]);
	
	treeNumber[i].reset();
	pT2vecArray[6*i+1] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh>"+finalBinNum1Array[i]+"&&zh<"+finalBinNum2Array[i],entriesArray[i]);

	treeNumber[i].reset();
	pT2vecArray[6*i+2] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh>"+finalBinNum2Array[i]+"&&zh<"+finalBinNum3Array[i],entriesArray[i]);

	treeNumber[i].reset();
	pT2vecArray[6*i+3] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh>"+finalBinNum3Array[i]+"&&zh<"+finalBinNum4Array[i],entriesArray[i]);

// 
	treeNumber[i].reset();
	pT2vecArray[6*i+4] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh>"+finalBinNum4Array[i]+"&&zh<"+finalBinNum5Array[i],entriesArray[i]);

	treeNumber[i].reset();
	pT2vecArray[6*i+5] = treeNumber[i].getDataVectors("nu","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&zh>"+finalBinNum5Array[i],entriesArray[i]);
}
...
for (int i = 0; i < 36; i++) {	
	...
	pT2histyArray[i] = new H1F().create(h1stname, nu_nBins, (DataVector)pT2vecArray[i].get(0),nu_lower,nu_higher);
	
}



// this next part looks at each individual histogram created ^^^^ there (36 histograms are 6 bins of zh for each of the heavy elements and deuterium elements) it then divides the nu data in each histogram into 4 bins
...
// these are the 4 nus for zh 1
	treeNumber[i].reset();
	finalvecArray[24*i] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i]+"&&zh<"+finalBinNum1Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+1] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i]+"&&nu<"+a1stfinalBinNum2Array[6*i]+"&&zh<"+finalBinNum1Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+2] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i]+"&&nu<"+a1stfinalBinNum3Array[6*i]+"&&zh<"+finalBinNum1Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+3] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i]+"&&zh<"+finalBinNum1Array[i],entriesArray[i]);

// these are the 4 nus for zh 2

	treeNumber[i].reset();
	finalvecArray[24*i+4] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i+1]+"&&zh>"+finalBinNum1Array[i]+"&&zh<"+finalBinNum2Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+5] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i+1]+"&&nu<"+a1stfinalBinNum2Array[6*i+1]+"&&zh>"+finalBinNum1Array[i]+"&&zh<"+finalBinNum2Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+6] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i+1]+"&&nu<"+a1stfinalBinNum3Array[6*i+1]+"&&zh>"+finalBinNum1Array[i]+"&&zh<"+finalBinNum2Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+7] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i+1]+"&&zh>"+finalBinNum1Array[i]+"&&zh<"+finalBinNum2Array[i],entriesArray[i]);


// these are the 4 nus for zh 3

	treeNumber[i].reset();
	finalvecArray[24*i+8] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i+2]+"&&zh>"+finalBinNum2Array[i]+"&&zh<"+finalBinNum3Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+9] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i+2]+"&&nu<"+a1stfinalBinNum2Array[6*i+2]+"&&zh>"+finalBinNum2Array[i]+"&&zh<"+finalBinNum3Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+10] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i+2]+"&&nu<"+a1stfinalBinNum3Array[6*i+2]+"&&zh>"+finalBinNum2Array[i]+"&&zh<"+finalBinNum3Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+11] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i+2]+"&&zh>"+finalBinNum2Array[i]+"&&zh<"+finalBinNum3Array[i],entriesArray[i]);


// these are the 4 nus for zh 4

	treeNumber[i].reset();
	finalvecArray[24*i+12] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i+3]+"&&zh>"+finalBinNum3Array[i]+"&&zh<"+finalBinNum4Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+13] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i+3]+"&&nu<"+a1stfinalBinNum2Array[6*i+3]+"&&zh>"+finalBinNum3Array[i]+"&&zh<"+finalBinNum4Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+14] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i+3]+"&&nu<"+a1stfinalBinNum3Array[6*i+3]+"&&zh>"+finalBinNum3Array[i]+"&&zh<"+finalBinNum4Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+15] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i+3]+"&&zh>"+finalBinNum3Array[i]+"&&zh<"+finalBinNum4Array[i],entriesArray[i]);


// these are the 4 nus for zh 5

	treeNumber[i].reset();
	finalvecArray[24*i+16] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i+4]+"&&zh>"+finalBinNum4Array[i]+"&&zh<"+finalBinNum5Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+17] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i+4]+"&&nu<"+a1stfinalBinNum2Array[6*i+4]+"&&zh>"+finalBinNum4Array[i]+"&&zh<"+finalBinNum5Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+18] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i+4]+"&&nu<"+a1stfinalBinNum3Array[6*i+4]+"&&zh>"+finalBinNum4Array[i]+"&&zh<"+finalBinNum5Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+19] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i+4]+"&&zh>"+finalBinNum4Array[i]+"&&zh<"+finalBinNum5Array[i],entriesArray[i]);

// these are the 4 nus for zh 6

	treeNumber[i].reset();
	finalvecArray[24*i+20] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu<"+a1stfinalBinNum1Array[6*i+5]+"&&zh>"+finalBinNum5Array[i],entriesArray[i]);
	

	treeNumber[i].reset();
	finalvecArray[24*i+21] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum1Array[6*i+5]+"&&nu<"+a1stfinalBinNum2Array[6*i+5]+"&&zh>"+finalBinNum5Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+22] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum2Array[6*i+5]+"&&nu<"+a1stfinalBinNum3Array[6*i+5]+"&&zh>"+finalBinNum5Array[i],entriesArray[i]);

	treeNumber[i].reset();
	finalvecArray[24*i+23] = treeNumber[i].getDataVectors("pT2","pFidCut==1&&eFidCut==1&&iTgt=="+treeTarget[i]+"&&nu>"+a1stfinalBinNum3Array[6*i+5]+"&&zh>"+finalBinNum5Array[i],entriesArray[i]);
...
// determines the average value of pT^2 from each zh&nu division
...
double carbon_differencebin2q4 = histyMean[31]-histyMean[7]; 
...
double carbon_differencebin3q4 = histyMean[35]-histyMean[11]; 
...
double iron_differencebin3q4 = histyMean[83] - histyMean[59]; 
...
double carbon_differencebin4q3 = histyMean[38]-histyMean[14]; 
...
double iron_differencebin4q4 = histyMean[87] - histyMean[63]; 
...
double lead_differencebin4q4 = histyMean[135] - histyMean[111]; 


double carbon_differencebin5q1 = histyMean[16]-histyMean[40]; 
double carbon_differencebin5q2 = histyMean[41]-histyMean[17]; 
...
double iron_differencebin5q3 = histyMean[90] - histyMean[66]; 
...
// these are all backwards...but by backwards these are the ones where the pt squared actually goes in the direction we thought it would (where the pt squared is bigger for bigger atoms. This is consistent for the 6th interval of zh with q2 and nu. wonder what this means
...
double lead_differencebin6q1 = histyMean[116] - histyMean[140]; 
...
deltaleaddiffmeanbin5q4 = Math.sqrt((errorMean[139])*(errorMean[139])-(errorMean[115])*(errorMean[115])); 
...
deltaleaddiffmeanbin6q3 = Math.sqrt((errorMean[142])*(errorMean[142])-(errorMean[118])*(errorMean[118])); 
...
TCanvas c1 = new TCanvas("nu",800,800);
...
System.out.println("Black Square is the lowest range of nu");
System.out.println("Red Triangle is the second lowest range of nu");
System.out.println("Green Inverted Triangle is the second highest range of nu");
System.out.println("Blue Circle is the highest range of nu");
